...
// Grammar for highlighting LogQL outside of a full code editor (e.g. query previews). Shaped to be
// usable as a Prism.js `Grammar` without depending on the `prismjs` package for its types.
